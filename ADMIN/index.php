...
<head>
    ...
    <title>LIFELINE DONATION Login</title>
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <h2></h2>
                            <div style="background: url('images/admin_image/Login.jpg') no-repeat; background-size: cover;" class="col-lg-6 d-none d-lg-block bg-login-image"></div>
                            <div class="col-lg-6">
                                <div class="p-5">
